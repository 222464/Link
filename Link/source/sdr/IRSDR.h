...
namespace sdr {
	...
	public:
		...
		void learn(const std::vector<float> &predictionErrors, float lambda, float learnFeedForward, float learnRecurrent, float learnBoost, float boostSparsity, float weightDecay, float maxWeightDelta = 0.5f);
